module.exports = app => {
  ...
  HRC721.associate = () => {
    ...
    EVMReceiptLog.belongsTo(HRC721, {as: 'hrc721', foreignKey: 'address', sourceKey: 'contractAddress'})
    HRC721.hasOne(EVMReceiptLog, {as: 'logs', foreignKey: 'address', sourceKey: 'contractAddress'})
