module.exports = app => {
  ...
  HRC20.associate = () => {
    ...
    EVMReceiptLog.belongsTo(HRC20, {as: 'hrc20', foreignKey: 'address', sourceKey: 'contractAddress'})
    HRC20.hasMany(EVMReceiptLog, {as: 'logs', foreignKey: 'address', sourceKey: 'contractAddress'})
