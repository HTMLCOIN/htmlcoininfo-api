...
class ContractService extends Service {
  ...
  async getContractSummary(contractAddress, addressIds) {
    const {Contract, Hrc20: HRC20, Hrc20Statistics: HRC20Statistics, Hrc721: HRC721} = this.ctx.model
    ...
    return {
      ...
      ...contract.type === 'hrc20' ? {
        hrc20: {
          ...
          holders: contract.hrc20.statistics.holders,
          transactions: contract.hrc20.statistics.transactions
        }
      } : {},
